...
#-------------------------------------------------------
#rm(taxa)
#taxa <- assignTaxonomy(seqtab.nochim, "/local/projects-t3/SerreDLab-3/bogaleh/Bact16S_HiSeq3/Fastq_3/silva_nr_v128_train_set.fa.gz", multithread=TRUE, tryRC=TRUE)
#taxa <- addSpecies(taxa, "/local/projects-t3/SerreDLab-3/bogaleh/Bact16S_HiSeq3/Fastq_3/silva_species_assignment_v128.fa.gz", tryRC=TRUE, allowMultiple=3)
#taxa_for_species <- assignTaxonomy(seqtab.nochim, "/local/projects-t3/SerreDLab-3/bogaleh/Bact16S_HiSeq_3/Fastq_Reads3/silva_nr_v128_train_set.fa.gz", multithread=TRUE, tryRC=TRUE)
#taxa_for_species <- addSpecies(taxa_for_species, "/local/projects-t3/SerreDLab-3/bogaleh/Bact16S_HiSeq_3/Fastq_Reads3/silva_species_assignment_v128.fa.gz", tryRC=TRUE, allowMultiple=TRUE)
